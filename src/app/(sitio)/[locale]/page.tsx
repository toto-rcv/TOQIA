  ...
  return (
    <section id="inicio" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-5 pb-16 pt-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] lg:gap-8 lg:px-8 lg:pb-24 lg:pt-16">
        ...
        <Reveal delay={0.2} x={200} y={0} className="relative order-first lg:order-none">
...
function Paso({
  ...
  return (
    <>
      <Reveal as="li" delay={numero * 0.1} className="flex flex-col items-center text-center">
        <span
          aria-hidden
